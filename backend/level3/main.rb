...
#calculate full prices of rentals with built in commission structure
output = {rentals: []}
rentals.each do |rental|
  output[:rentals] << { 'id' => rental.id, 'price' => rental.full_price, 'commission' => rental.commission_structure }
end

puts "printing full prices of rentals with built in commission structure"
puts "-------------------"
