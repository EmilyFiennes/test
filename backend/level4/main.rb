...
#calculate full prices of rentals with built in commission structure and deductible reduction
output = {rentals: []}
rentals.each do |rental|
  output[:rentals] << { 'id' => rental.id, 'price' => rental.full_price, 'options'=> {'deductible_reduction' => rental.calculate_deductible_reduction_amount }, 'commission' => rental.commission_structure }
end

puts "printing full prices of rentals with built in commission structure and deductible_reduction"
puts "-------------------"
